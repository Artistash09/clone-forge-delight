...
const comparisonRows = [
  { feature: "Email accuracy", them: "~90%", us: "98% verified", usWin: true, themLose: true },
  { feature: "Mobile coverage", them: "~45M", us: "60M direct dials", usWin: true, themLose: true },
  { feature: "Bulk enrichment", them: "Limited", us: "✓ All paid plans", usWin: true, themLose: true },
  { feature: "Multi-seat / agency support", them: "Basic", us: "Full workspaces + credit pools", usWin: true, themLose: true },
  { feature: "Intent data filters", them: "✗", us: "✓ (Growth+)", usWin: true, themLose: true },
...
export default function VsLusha() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-20 pb-10 px-6 text-center max-w-[900px] mx-auto">
        <div className="inline-block bg-il-green/10 border border-il-green/30 rounded-full px-5 py-2 text-green-400 text-sm font-semibold mb-6">
          ✓ More features. Better team support. Same price.
        </div>
        <h1 className="section-title">Inbound Labs vs Lusha</h1>
        <p className="text-il-gray-light text-[16px] leading-relaxed mt-4">
          Lusha is great for individual prospectors but lacks team/agency features. Inbound Labs has bulk enrichment and multi-seat at the same price point. Our intent data filters don't exist in Lusha.
        </p>
      </div>
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b border-il-border">
                ...
                <th className="text-center text-sm text-il-gray-light font-semibold py-3 px-4">Lusha</th>
      ...
      <div className="max-w-[900px] mx-auto px-6 py-12">
        <h2 className="section-title" style={{ fontSize: "28px" }}>Where Lusha still wins</h2>
        <p className="text-il-gray-light text-sm mb-6">We believe in honest comparisons:</p>
        <div className="space-y-4">
          {[
            "Lusha has a simpler, more streamlined UI for individual prospectors",
            "Lusha's community-contributed data adds unique contact points",
            "Lusha's onboarding is faster for single-user setups",
          ].map((point) => (
      ...
      <div className="max-w-[900px] mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-5 mt-8">
          {[
            { emoji: "👥", title: "Growing sales teams", desc: "Lusha's team features are basic. Inbound Labs has full workspace management and credit pools." },
            { emoji: "🏢", title: "Agencies running multiple clients", desc: "Lusha wasn't built for agencies. We have multi-client workspaces and white-label exports." },
            { emoji: "🎯", title: "Teams needing intent data", desc: "Lusha doesn't offer intent filters. If you want to target in-market buyers, switch to Inbound Labs." },
          ].map((card) => (
